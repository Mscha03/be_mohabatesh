...
import com.example.myapplication.bottomsheet.EditTaskBottomSheet;
...
public class EditDelete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit.setOnClickListener(v -> {
            ...
            editTaskBottomSheet.setArguments(bundle);
            editTaskBottomSheet.show(getSupportFragmentManager(), "ModalBottomSheet");
            Log.d(TAG, "onClick: showing EditTaskBottomSheet");
        });
