...
private const val DB_NAME = "weekly_habit"
...
class WeeklyHabitDB(context: Context) : SQLiteOpenHelper(context, DB_NAME, null, DB_VERSION) {
    ...
    fun getAllWeeks(routineId: Int): Cursor? {
        val db = this.readableDatabase
        val cursor = db.query(
            DAYS_TABLE_NAME,
            null,
